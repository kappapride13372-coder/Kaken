...
# Strategy parameters
# =======================
symbols = ["AAVEUSD","ADAUSD","AEROUSD","ALGOUSD","APEUSD","APTUSD","ARBUSD","ATOMUSD","AVAXUSD","AVNTUSD","AXSUSD","BATUSD","BCHUSD","BLURUSD","BNBUSD","BONKUSD","CHZUSD","CNUSD","COMPUSD","CRVUSD","DAIUSD","DASHUSD","DOGUSD","DOTUSD","DYDXUSD","EIGENUSD","ENAUSD","ENSUSD","ETCUSD","ETHUSD","FARTCOINUSD","FETUSD","FILUSD","FLOKIUSD","FLOWUSD","FLRUSD","GALAUSD","GOATUSD","GRTUSD","ICPUSD","IMXUSD","INJUSD","JASMYUSD","JUPUSD","KAITOUSD","KASUSD","KAVAUSD","KEEPUSD","KNCUSD","KSMUSD","KUSD","LDOUSD","LINKUSD","LRCUSD","LTCUSD","MANAUSD","MELANIAUSD","MEWUSD","MINAUSD","MOGUSD","MOODENGUSD","MORPHOUSD","NANOUSD","NEARUSD","OMGUSD","OMUSD","ONDOUSD","OPUSD","PAXGUSD","PENGUUSD","PEPEUSD","PLUSD","POLUSD","POPCATUSD","PUMPUSD","PYTHUSD","QTUMUSD","RAYUSD","RENDERUSD","ROUSD","RUNEUSD","RXUSD","SAGAUSD","SANDUSD","SCUSD","SEIUSD","SHIBUSD","SNXUSD","SOLUSD","SPXUSD","STBLUSD","STRKUSD","STXUSD","SUIUSD","SUSHIUSD","SYRUPUSD","TAOUSD","TIAUSD","TONUSD","TRUMPUSD","TRXUSD","TURBOUSD","TZUSD","UNIUSD","USDCUSD","USDTUSD","VIRTUALUSD","WIFUSD","WLDUSD","WLFIUSD","WUSD","XBTUSD","XDGUSD","XLMUSD","XMRUSD","XRPUSD","YFIUSD","ZECUSD"]
bollinger_length = 60
bollinger_std = 5
