...
# =======================
symbols = [
    "AAVEUSD", "ADAUSD", "AEROUSD", "ALGOUSD", "APEUSD", "APTUSD", "ARBUSD", "ATOMUSD", "AVAXUSD",
    "AVNTUSD", "AXSUSD", "BATUSD", "BCHUSD", "BLURUSD", "BNBUSD", "BONKUSD", "CHZUSD", "COMPUSD",
    "CRVUSD", "DAIUSD", "DASHUSD", "DOGEUSD", "DOTUSD", "DYDXUSD", "EIGENUSD", "ENAUSD", "ENSUSD",
    "FARTCOINUSD", "FETUSD", "FILUSD", "FLOKIUSD", "FLOWUSD", "FLRUSD", "GALAUSD", "GRTUSD", "ICPUSD",
    "IMXUSD", "INJUSD", "JASMYUSD", "JUPUSD", "KAITOUSD", "KASUSD", "KAVAUSD", "KEEPUSD", "KNCUSD",
    "KSMUSD", "LDOUSD", "LINKUSD", "LRCUSD", "MANAUSD", "MELANIAUSD", "MEWUSD", "MINAUSD", "MOGUSD",
    "MOODENGUSD", "MORPHOUSD", "NANOUSD", "NEARUSD", "OMGUSD", "OMUSD", "ONDOUSD", "OPUSD", "PAXGUSD",
    "PENGUUSD", "PEPEUSD", "POLUSD", "POPCATUSD", "PUMPUSD", "PYTHUSD", "QTUMUSD", "RAYUSD", "RENDERUSD",
    "RUNEUSD", "SAGAUSD", "SANDUSD", "SCUSD", "SEIUSD", "SHIBUSD", "SNXUSD", "SOLUSD", "SPXUSD", "STBLUSD",
    "STRKUSD", "STXUSD", "SUIUSD", "SUSHIUSD", "SYRUPUSD", "TAOUSD", "TIAUSD", "TONUSD", "TRUMPUSD",
    "TRXUSD", "TURBOUSD", "UNIUSD", "USDCUSD", "USDTUSD", "VIRTUALUSD", "WIFUSD", "WLDUSD", "WLFIUSD",
    "WUSDUSD", "XCNUSD", "XDGUSD", "ETCUSD", "ETHUSD", "LTCUSD", "XPLUSD", "XTZUSD", "XBTUSD", "XLMUSD",
    "XMRUSD", "XRPUSD", "ZECUSD", "YFIUSD", "ZKUSD", "ZROUSD", "ZRXUSD"
]
bollinger_length = 60
bollinger_std = 5
